#ifndef __WSPR_MESSAGE_PICO_TRACKER_WSPR_1_H__
#define __WSPR_MESSAGE_PICO_TRACKER_WSPR_1_H__


#include "WSPRMessage.h"


class WSPRMessagePicoTrackerWSPR1
: public WSPRMessage
{
public:
...
#endif  // __WSPR_MESSAGE_PICO_TRACKER_WSPR_1_H__
