#ifndef __KEYPAD_16_BUTTON_H__
#define __KEYPAD_16_BUTTON_H__
...
private:
    ...
    static const uint8_t  BUTTON_COUNT             = 16;
    
public:
    Keypad16Button(const Keypad16ButtonConfig cfg)
    : buttonStateList_{
        { cfg.pinK5, cfg.pinK1, '1' },
        { cfg.pinK6, cfg.pinK1, '2' },
        { cfg.pinK7, cfg.pinK1, '3' },
        { cfg.pinK8, cfg.pinK1, 'A' },
        
        { cfg.pinK5, cfg.pinK2, '4' },
        { cfg.pinK6, cfg.pinK2, '5' },
        { cfg.pinK7, cfg.pinK2, '6' },
        { cfg.pinK8, cfg.pinK2, 'B' },
        
        { cfg.pinK5, cfg.pinK3, '7' },
        { cfg.pinK6, cfg.pinK3, '8' },
        { cfg.pinK7, cfg.pinK3, '9' },
        { cfg.pinK8, cfg.pinK3, 'C' },
        
        { cfg.pinK5, cfg.pinK4, '*' },
        { cfg.pinK6, cfg.pinK4, '0' },
        { cfg.pinK7, cfg.pinK4, '#' },
        { cfg.pinK8, cfg.pinK4, 'D' }
    }
    {
