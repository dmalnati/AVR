...
private:
    ...
    static uint16_t CalculateTimerTopValue()
    {
        ...
        //uint16_t top = ticksPerPeriod - 166;
        //uint16_t top = ticksPerPeriod - 155;    // working, 8336
        uint16_t top = ticksPerPeriod - 156;    // basically the same
        //uint16_t top = ticksPerPeriod - 160;  // working at 8325
        //uint16_t top = ticksPerPeriod - 162;    // not, 8327
    ...
    static ModemAnalogPwm ma_;

    ModemAnalogPwmFrequencyConfig fcList_[2];
...
ModemAnalogPwm ModemBell202Pwm::ma_;
ModemBell202Pwm::CommandQueue ModemBell202Pwm::cmdQueue_;
