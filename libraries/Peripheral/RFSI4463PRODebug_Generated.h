...
void Print(RFSI4463PRO::PART_INFO_REP &val)
{
    ...
    Serial.print(val.PART1.PART1);
    Serial.print(" (0x");
    Serial.print(val.PART1.PART1, HEX);
    Serial.print(")");
    Serial.println();
    Serial.print("PART2.PART2      : ");
    Serial.print(val.PART2.PART2);
    Serial.print(" (0x");
    Serial.print(val.PART2.PART2, HEX);
    Serial.print(")");
    Serial.println();
    ...
    Serial.print(")");
    Serial.println();
    Serial.print("ID1.ID1          : ");
    Serial.print(val.ID1.ID1);
    Serial.print(" (0x");
    Serial.print(val.ID1.ID1, HEX);
    Serial.print(")");
    Serial.println();
    Serial.print("ID2.ID2          : ");
    Serial.print(val.ID2.ID2);
    Serial.print(" (0x");
    Serial.print(val.ID2.ID2, HEX);
    Serial.print(")");
    Serial.println();
